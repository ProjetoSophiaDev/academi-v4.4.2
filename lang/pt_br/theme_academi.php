...
$string['slidebtntext1_default'] = '';
$string['slidebtntext2_default'] = '';
$string['slidebtntext3_default'] = 'Conheça nossa história';
$string['slidebtntext4_default'] = 'Portal da UTFPR';
$string['slidebtntext5_default'] = 'Saiba como';
$string['slidebtnurl1_default'] = '';
$string['slidebtnurl2_default'] = '';
$string['slidebtnurl3_default'] = 'https://sophia.ct.utfpr.edu.br/mod/page/';
$string['slidebtnurl4_default'] = 'https://www.utfpr.edu.br/';
$string['slidebtnurl5_default'] = 'https://sophia.ct.utfpr.edu.br/mod/page/';
$string['slidecaption1_default'] = '';
$string['slidecaption2_default'] = '';
$string['slidecaption3_default'] = 'Portal Sophia';
$string['slidecaption4_default'] = '';
$string['slidecaption5_default'] = 'Gostaria de ofertar um curso pelo SOP';
$string['slidecontentPosition1_default'] = 'centerRight';
$string['slidecontentPosition2_default'] = 'centerRight';
$string['slidecontentPosition3_default'] = 'centerRight';
$string['slidecontentPosition4_default'] = 'centerRight';
$string['slidecontentPosition5_default'] = 'centerLeft';
$string['slidecontentstatus1_default'] = NO;
$string['slidecontentstatus2_default'] = NO;
$string['slidecontentstatus3_default'] = YES;
$string['slidecontentstatus4_default'] = YES;
$string['slidecontentstatus5_default'] = YES;
$string['slidedesc1_default'] = '';
$string['slidedesc2_default'] = '';
$string['slidedesc3_default'] = 'Cursos online, livres e gratuitos promovidos pela UTFPR-CT (Universidade Tecnológica Federal do Paraná - Campus Curitiba)';
$string['slidedesc4_default'] = 'Aprenda a qualquer momento e em qualquer lugar com certificação UTFPR';
$string['slidedesc5_default'] = '';
