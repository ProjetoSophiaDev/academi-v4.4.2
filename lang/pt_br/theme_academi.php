...
$string['backgroundimage_desc'] = 'The image to display as the background for the site\'s theme. <br> <b> Note: </b> The background image works based on the parent theme "Boost". If the background image is deleted in the "Boost" theme, it will also be deleted in our "Academi" theme.';
...
$string['defaultaddress'] = 'Av. Sete de Setembro, 3165 - Rebouças CEP 80230-901 - Curitiba - PR - Brasil';
$string['defaultemailid'] = 'portalsophia-ct@utfpr.edu.br';
$string['defaultphoneno'] = '+55 (41) 3310-4545';
...
$string['footnotedefault'] = '<p>O Portal Sophia é uma plataforma de Curso Online Aberto e Massivo (MOOC) que oferece cursos de curta e média duração gratuitos, como alternativa de formação ao desenvolvimento rápido de competências para o trabalho.</p>';
$string['footnotedesc'] = 'Tudo o que você adicionar a esta área de texto será exibido no rodapé de todo o seu site Moodle.';
$string['headerheading'] = 'General';
$string['home'] = "Home";
$string['icon'] = 'Icon';
$string['iconcolor'] = 'Icon Color';
$string['icondesc'] = 'Digite o nome do ícone que deseja usar. Veja a lista <a href="https://fontawesome.com/v4/cheatsheet/" target="_new">aqui</a>. Basta digitar o que vem depois do "fa-".';
$string['image'] = 'Image';
$string['imagedesc'] = 'Faça upload de uma imagem personalizada para o "Elemento em destaque". Recomendamos que você use imagens com dimensões de 75 x 75 pixels.';
$string['importsettings'] = "Importe outras configurações predefinidas.";
$string['importthemesettings']  = 'Importe as configurações de {$a}';
$string['info'] = 'Informações';
$string['infolink'] = 'Links de informações';
...
$string['jumbotronbtntarget_desc'] = 'Escolha esta opção se o link do botão deve ser aberto em janela "Mesma" ou "Nova" no bloco "Jumbotron".';
...
$string['knowmore'] = 'Conheça mais';
$string['large'] = 'Large';
$string['learnanytime'] = '';
$string['learnanytimedesc'] = 'A COTED-CT constitui uma unidade de apoio ao ensino, pesquisa e extensão, à comunidade interna e externa mediante parcerias em projetos com as secretarias de educação estadual e municipal e outras instituições da sociedade civil, na área de utilização das Tecnologias de Informação e de Comunicação na Educação.';
...
$string['mspotheading'] = 'Ponto de marketing';
...
$string['sitefblockurl1_default'] = '';
$string['sitefblockurl2_default'] = '';
$string['sitefblockurl3_default'] = 'https://sophia.ct.utfpr.edu.br/mod/page/';
$string['sitefblockurl4_default'] = 'https://www.utfpr.edu.br/';
$string['slide1btntext_default'] = '';
$string['slide2btntext_default'] = '';
$string['slide3btntext_default'] = 'Conheça nossa história';
$string['slide4btntext_default'] = 'Portal da UTFPR';
$string['slide5btntext_default'] = 'Saiba como';
$string['slide1btnurl_default'] = '';
$string['slide2btnurl_default'] = '';
$string['slide3btnurl_default'] = 'https://sophia.ct.utfpr.edu.br/mod/page/';
$string['slide4btnurl_default'] = 'https://www.utfpr.edu.br/';
$string['slide5btnurl_default'] = 'https://sophia.ct.utfpr.edu.br/mod/page/';
$string['slide1contentPosition_default'] = 'centerRight';
$string['slide2contentPosition_default'] = 'centerRight';
$string['slide3contentPosition_default'] = 'centerRight';
$string['slide4contentPosition_default'] = 'centerRight';
$string['slide5contentPosition_default'] = 'centerRight';
$string['slide1contentstatus_default'] = NO;
$string['slide2contentstatus_default'] = NO;
$string['slide3contentstatus_default'] = YES;
$string['slide4contentstatus_default'] = YES;
$string['slide5contentstatus_default'] = YES;
$string['slide1caption_default'] = '';
$string['slide2caption_default'] = '';
$string['slide3caption_default'] = 'Portal Sophia';
$string['slide4caption_default'] = '';
$string['slide5caption_default'] = 'Gostaria de ofertar um curso pelo SOP';
$string['slide1desc_default'] = '';
$string['slide2desc_default'] = '';
$string['slide3desc_default'] = 'Cursos online, livres e gratuitos promovidos pela UTFPR-CT (Universidade Tecnológica Federal do Paraná - Campus Curitiba)';
$string['slide4desc_default'] = 'Aprenda a qualquer momento e em qualquer lugar com certificação UTFPR';
$string['slide5desc_default'] = '';
...
$string['socialmediadesc'] = '<strong>Este bloco contém mídias sociais</strong>';
$string['socialmediaicon1_default'] = 'youtube';
$string['socialmediaicon2_default'] = 'instagram';
...
$string['socialmediaicon_desc'] = 'O ícone de mídia social da sua organização';
$string['socialmediaiconcolor1_default'] = '#C3DDFD';
$string['socialmediaiconcolor2_default'] = '#C3DDFD';
...
$string['socialmediaiconcolor_desc'] = 'Altere as cores dos ícones de mídia social';
$string['socialmediaurl1_default'] = 'https://www.youtube.com/channel/UCFeP57KSr13ppV9rDUZl1oQ';
$string['socialmediaurl2_default'] = 'https://www.instagram.com/coted.ct/';
...
$string['socialmediaurl_desc'] = 'O URL de mídia social da sua organização';
