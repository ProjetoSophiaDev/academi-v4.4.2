...
$string['copyright_default'] = 'Copyright &copy; 2024 - Developed by <a href="http://lmsace.com">LMSACE.com</a>. Powered by <a href="https://moodle.org">Moodle</a>';
$string['copyright_footer'] = 'Copyright';
$string['custom'] = "Custom";
$string['customcss'] = 'Custom CSS';
$string['customcssdesc'] = 'Whatever CSS rules you add to this textarea will be reflected in every page, making for easier customization of this theme.';
$string['defaultaddress'] = 'Av. Sete de Setembro, 3165 - Rebouças CEP 80230-901 - Curitiba - PR - Brazil';
...
$string['infolinkdefault'] = 'UTFPR Portal | http://portal.utfpr.edu.br/institucional
COTED Portal | https://utfpr.curitiba.br/coted
Terms of use | https://sophia.ct.utfpr.edu.br/mod/page/view.php?id=1735
...
$string['large'] = 'Large';
$string['learnanytime'] = '';
$string['learnanytimedesc'] = 'COTED-CT constitutes a support unit for teaching, research and extension, to the internal and external community through partnerships in projects with state and municipal education departments and other civil society institutions, in the area of ​​using Information Technologies and Communication in Education.';
...
$string['promotedtitledesc'] = 'Please give the Promoted courses block title,either language key or Text.For ex: lang:display or Display';
...
$string['sitefblockurl2_default'] = 'https://www.slide2btnurl.com/';
$string['sitefblockurl3_default'] = 'https://sophia.ct.utfpr.edu.br/mod/page/';
$string['sitefblockurl4_default'] = 'https://www.utfpr.edu.br/';
$string['sitefblockurl5_default'] = 'https://sophia.ct.utfpr.edu.br/mod/page/';
$string['slide1btntext_default'] = '';
$string['slide2btntext_default'] = '';
$string['slide3btntext_default'] = 'Discover our history';
$string['slide4btntext_default'] = 'UTFPR Porthal';
$string['slide5btntext_default'] = 'Find out how';
$string['slide1btnurl_default'] = '';
$string['slide1btnur2_default'] = '';
$string['slide1btnur3_default'] = 'https://sophia.ct.utfpr.edu.br/mod/page/';
$string['slide1btnur4_default'] = 'https://www.utfpr.edu.br/';
$string['slide1btnur5_default'] = 'https://sophia.ct.utfpr.edu.br/mod/page/';
...
$string['slide5caption_default'] = 'I would like to offer a course through SOP';
$string['slide1desc_default'] = '';
$string['slide2desc_default'] = '';
$string['slide3desc_default'] = 'Free online courses promoted by UTFPR-CT (Federal Technological University of Paraná - Campus Curitiba)';
$string['slide4desc_default'] = 'Learn anytime, anywhere with UTFPR certification';
